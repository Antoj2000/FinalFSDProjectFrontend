...
async function handleDelete() {
    ...
    await globalCtx.updateGlobals({cmd: 'deleteMeeting', newVal: {_id: props.id }, });
    }
    ...
    <section className={classes.detail}>
        ...
        <div className={classes.titleRow}>
            ...
            <div className={classes.gearWrapper}>
                ...
                {menuOpen && (<div className={classes.dropdown}>
                    <button type="button" className={classes.dropdownItem} onClick={handleUpdate}>Update</button>
                    <button type="button" className={classes.dropdownItemDanger} onClick={handleDelete}>Delete</button>
                    </div>
                )}
            </div>
        </div>
